const translations = {
    en: {
        ...
        faqQ2: "How do I add students, and is there a limit to how many I can add?",
        faqA2: "Yes, you can add students in Manage Students: type the student’s name, press Add, and switch between students anytime—data is saved locally and automatically. There’s no limit to how many students you can add!",
        faqQ3: "What’s the highest rank?",
        faqA3: "Star Admiral—earn six stars in every exercise in every chapter!",
        faqQ4: "Can I send suggestions or questions?",
        faqA4: "Yes, feel free to email: staracademypianoschool@gmail.com",
        faqQ5: "Why did my progress disappear?",
        faqA5: "If you cleared your browser history, all star data was removed as it’s stored in the browser’s cache. If you imported a user with your name from another device via a link or QR code created on the For Teachers page, your user data was overwritten by the imported user.",
        faqQ6: "How does the ranking system work in Star Academy?",
        faqA6: "In Star Academy, you climb ranks by earning stars in exercises. You start as an Explorer and need to earn six stars in 16 exercises to become a Star Cadet. To reach the next rank, Star Officer, you must complete Part 1 in all seven chapters. Each rank requires completing more parts in the chapters, up to Star Admiral, where you have six stars in every exercise in every chapter.",
        faqQ7: "Do I need a piano to use Star Academy?",
        faqA7: "To use Star Academy, you need access to a piano or keyboard to practice the exercises in the Star Academy Piano School. A keyboard with at least 61 keys and touch sensitivity works well for beginners, but a piano is ideal for developing proper technique. You don’t need to own a piano—you can use one at a school or rent one if needed.",
        faqQ8: "How much time should I spend practicing each day?",
        faqA8: "We recommend practicing 15–30 minutes per day in addition to the time you spend on pieces, depending on your level and age. Beginners can start with 15 minutes, while more advanced students can aim for 30 minutes. Try to practice daily to make steady progress, and focus on your active exercises to earn stars.",
        faqQ9: "Can I use Star Academy if I already know how to play the piano?",
        faqA9: "Yes, if you already know how to play the piano, you can still use Star Academy! Start with exercises that match your level, or begin from the start and collect some easy stars for a good foundation. Earn stars to climb ranks and improve your skills, whether you’re a beginner or advanced.",
        faqQ10: "What should I do if I have technical issues with the website?",
        faqA10: "If you have technical issues with the website, try refreshing the page or checking your internet connection. If the problem persists, contact us at staracademypianoschool@gmail.com, and we’ll assist you. Also, make sure not to clear your browser’s cache, as it will remove your progress.",
    ...
    sv: {
        ...
        faqA1: "Gå till Stjärnkartan med i menyn och scrolla till vänster för att se en förklaring till hur du använder stjärnkartan.",
        faqQ2: "Hur lägger jag till elever och finns det en gräns för hur många jag kan lägga till?",
        faqA2: "Ja, du kan lägga till elever i Hantera elever: skriv elevens namn, tryck Lägg till, och skifta mellan elever när du vill—data sparas lokalt och automatiskt. Det finns ingen gräns för hur många elever du kan lägga till!",
        faqQ3: "Vilken är högsta rangen?",
        faqA3: "Stjärnamiral—få sex stjärnor på alla övningar i alla kapitel!",
        faqQ4: "Kan jag skicka förslag och frågor?",
        faqA4: "Ja, maila gärna: stjarnakademien@gmail.com",
        faqQ5: "Varför försvann mina framsteg?",
        faqA5: "Om du har rensat din historik i din webbläsare så försvann all data som visar stjärnor eftersom denna lagras i webbläsarens cacheminne. Om du har importerat en användare med ditt namn från en annan enhet via en länk eller QR-kod som skapats på För lärare-sidan så har din användare skrivits över av den importerade användaren.",
        faqQ6: "Hur fungerar rankningssystemet i Stjärnakademien?",
        faqA6: "I Stjärnakademien klättrar du i rang genom att tjäna stjärnor i övningar. Du börjar som Utforskare och behöver samla sex stjärnor i 16 övningar för att bli Stjärnkadett. För att nå nästa rang, Stjärnofficer, måste du klara del 1 i alla sju kapitel. Varje rang kräver att du slutför fler delar i kapitlen, upp till Stjärnamiral, där du har sex stjärnor i alla övningar i alla kapitel.",
        faqQ7: "Behöver jag ett piano för att använda Stjärnakademien?",
        faqA7: "För att använda Stjärnakademien behöver du tillgång till ett piano eller ett keyboard för att öva på övningarna i Stjärnakademiens Pianoskola. Ett keyboard med minst 61 tangenter och touch sensitivity fungerar bra för nybörjare, men ett piano är idealiskt för att utveckla rätt teknik. Du behöver inte äga ett piano—du kan använda ett på en skola eller hyra ett om det behövs.",
        faqQ8: "Hur mycket tid bör jag lägga på att öva varje dag?",
        faqA8: "Vi rekommenderar att du övar 15–30 minuter per dag utöver den tid du lägger på stycken, beroende på din nivå och ålder. Nybörjare kan börja med 15 minuter, medan mer avancerade elever kan sikta på 30 minuter. Försök att öva varje dag för att göra stadiga framsteg, och fokusera på dina aktiva övningar för att tjäna stjärnor.",
        faqQ9: "Kan jag använda Stjärnakademien om jag redan kan spela piano?",
        faqA9: "Ja, om du redan kan spela piano kan du fortfarande använda Stjärnakademien! Börja med övningar som matchar din nivå eller börja från början och samla några lätta stjärnor för att få en bra start. Tjäna stjärnor för att klättra i rang och förbättra dina färdigheter, oavsett om du är nybörjare eller avancerad.",
        faqQ10: "Vad gör jag om jag har tekniska problem med hemsidan?",
        faqA10: "Om du har tekniska problem med hemsidan, prova att ladda om sidan eller kontrollera din internetanslutning. Om problemet kvarstår, kontakta oss på stjarnakademien@gmail.com så hjälper vi dig. Se också till att inte rensa webbläsarens cache, eftersom det tar bort dina framsteg.",
