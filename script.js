const translations = {
    en: {
        ...
        faqQ4: "Why can't I click the stars on the Star Overview page to earn them?",
        faqA4: "The stars on the Rank Badge in the Star Overview are not clickable. They light up automatically based on the stars you earn by clicking in the Chapter pages and Star Map. The Rank Badge includes the middle section, where the first 16 completed exercises light up the small stars in the bottom field, showing your progress toward the Star Cadet rank. When this bottom field is full, the rank badge on the right updates from empty stars to all golden stars. The large stars in the four chevrons in the middle light up when you complete all four exercises in a Part across the chapters. The leftmost stars in the four chevrons correspond to Parts 1-4 in Chapter 1, the second stars correspond to Parts 1-4 in Chapter 2, and so on for all seven chapters. As each chevron fills, the rank badge on the right gains a matching chevron, reflecting your progress toward higher ranks.",
        faqQ5: "How does the ranking system work in North Star Piano School?",
        faqA5: "In North Star Piano School, you climb ranks by earning stars in exercises. You start as an Explorer and need to earn six stars in 16 exercises to become a Star Cadet. To reach the next rank, Star Officer, you must complete Part 1 in all seven chapters. Each rank requires completing more parts in the chapters, up to Star Admiral, where you have six stars in every exercise in every chapter.",
        ...
        faqA10: "If you have technical issues with the website, try refreshing the page or checking your internet connection. If the problem persists, contact us at northstarpianoschool@gmail.com, and we’ll assist you. Also, make sure not to clear your browser’s cache, as it will remove your progress.",
        faqQ11: "Can I send suggestions or questions?",
        faqA11: "Yes, feel free to email: northstarpianoschool@gmail.com",
    ...
    sv: {
        ...
        faqA4: "Stjärnorna på rangmärket i Stjärnöversikt är inte klickbara. De tänds automatiskt baserat på de stjärnor du får genom att klicka på Kapitel-sidorna och i Stjärnkartan. Rangmärket inkluderar den mittersta sektionen, där de första 16 slutförda övningarna tänder de små stjärnorna i det nedre fältet, vilket visar dina framsteg mot Stjärnkadett-rangen. När detta nedre fält är fullt uppdateras rangmärket till höger från tomma stjärnor till helt gyllene stjärnor. De stora stjärnorna i de fyra chevroner i mitten tänds när du slutför alla fyra övningar i en del över kapitlen. De vänstra stjärnorna i de fyra chevroner motsvarar Del 1-4 i Kapitel 1, de andra stjärnorna motsvarar Del 1-4 i Kapitel 2, och så vidare för alla sju kapitel. När varje chevron fylls får rangmärket till höger en motsvarande chevron, vilket visar dina framsteg mot högre ranger.",
        faqQ5: "Hur fungerar rangsystemet i Nordstjärnans Pianoskola?",
        faqA5: "I Nordstjärnans Pianoskola klättrar du i rang genom att tjäna stjärnor i övningar. Du börjar som Utforskare och behöver samla sex stjärnor i 16 övningar för att bli Stjärnkadett. För att nå nästa rang, Stjärnofficer, måste du klara del 1 i alla sju kapitel. Varje rang kräver att du slutför fler delar i kapitlen, upp till Stjärnamiral, där du har sex stjärnor i alla övningar i alla kapitel.",
        ...
        faqA8: "Det finns sex ranger i Nordstjärnans Pianoskola: Utforskare, Stjärnkadett, Stjärnofficer, Stjärnkapten, Stjärnkommendör och Stjärnamiral. Du klättrar i rang genom att tjäna stjärnor i övningar, och den högsta rangen, Stjärnamiral, uppnår du genom att få sex stjärnor på alla övningar i alla kapitel.",
