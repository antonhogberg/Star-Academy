const translations = {
    en: {
        ...
        popupIntro: "Click to reveal your Star Academy Piano School stars! Earn six stars in exercises to rise in rank—track your progress under Star Overview.",
        ...
        faqQ5: "Can I use Star Academy Piano School if I already know how to play the piano, and how advanced are the exercises?",
        faqA5: "Yes, even if you already know how to play the piano, you can use Star Academy Piano School! The exercises are divided into four parts with different levels: Part 1 is for beginners, Part 2 is for slightly more experienced students, Part 3 is for advanced students, and Part 4 features mostly very advanced exercises for experienced pianists. Start with exercises that match your level, or begin from the start to collect some easy stars. Earn stars to climb ranks and improve your skills, regardless of your level.",
        faqQ6: "How many ranks are there?",
        faqA6: "There are six ranks in Star Academy Piano School: Explorer, Star Cadet, Star Officer, Star Captain, Star Commander, and Star Admiral. You climb ranks by earning stars in exercises, and the highest rank, Star Admiral, is achieved by earning six stars in every exercise in every chapter.",
        faqQ7: "Do I need a piano to use Star Academy Piano School?",
        faqA7: "To use Star Academy Piano School, you need access to a piano or keyboard to practice the exercises in the Star Academy Piano School. A keyboard with at least 61 keys works well for beginners, but a piano is ideal for developing proper technique. You don’t need to own a piano—you can use one at a school or rent one if needed.",
        faqQ8: "What should I do if I have technical issues with the website?",
        faqA8: "If you have technical issues with the website, try refreshing the page or checking your internet connection. If the problem persists, contact us at staracademypianoschool@gmail.com, and we’ll assist you. Also, make sure not to clear your browser’s cache, as it will remove your progress.",
        faqQ9: "Can I send suggestions or questions?",
        faqA9: "Yes, feel free to email: staracademypianoschool@gmail.com",
        ...
        starMapDescription: "Welcome to the Star Map! Click on each star to track your progress in Star Academy Piano School. Earn up to six stars per exercise by practicing in the Piano School. Scroll to explore all chapters and exercises.",
    ...
    sv: {
        ...
        faqQ3: "Hur fungerar rangsystemet i Stjärnakademien?",
        faqA3: "I Stjärnakademien klättrar du i rang genom att tjäna stjärnor i övningar. Du börjar som Utforskare och behöver samla sex stjärnor i 16 övningar för att bli Stjärnkadett. För att nå nästa rang, Stjärnofficer, måste du klara del 1 i alla sju kapitel. Varje rang kräver att du slutför fler delar i kapitlen, upp till Stjärnamiral, där du har sex stjärnor i alla övningar i alla kapitel.",
        ...
        faqQ5: "Kan jag använda Stjärnakademien om jag redan kan spela piano, och hur avancerade är övningarna?",
        faqA5: "Ja, om du redan kan spela piano kan du ändå använda Stjärnakademien! Övningarna är uppdelade i fyra delar med olika nivåer: Del 1 är för nybörjare, Del 2 är för något mer erfarna elever, Del 3 är för avancerade elever, och Del 4 är överlag väldigt avancerade övningar för erfarna pianister. Börja med övningar som matchar din nivå eller starta från början för att samla några lätta stjärnor. Tjäna stjärnor för att klättra i rang och förbättra dina färdigheter, oavsett din nivå!",
        faqQ6: "Hur många ranger finns det?",
        faqA6: "Det finns sex ranger i Stjärnakademien: Utforskare, Stjärnkadett, Stjärnofficer, Stjärnkapten, Stjärnkommendör och Stjärnamiral. Du klättrar i rang genom att tjäna stjärnor i övningar, och den högsta rangen, Stjärnamiral, uppnår du genom att få sex stjärnor på alla övningar i alla kapitel.",
        faqQ7: "Behöver jag ett piano för att använda Stjärnakademien?",
        faqA7: "För att använda Stjärnakademien behöver du tillgång till ett piano eller ett keyboard för att öva på övningarna i Stjärnakademiens pianoskola. Ett keyboard med minst 61 tangenter fungerar bra för nybörjare, men ett piano är idealiskt för att utveckla rätt teknik. Du behöver inte äga ett piano—du kan använda ett på en skola eller hyra ett om det behövs.",
        faqQ8: "Vad gör jag om jag har tekniska problem med hemsidan?",
        faqA8: "Om du har tekniska problem med hemsidan, prova att ladda om sidan eller kontrollera din internetanslutning. Om problemet kvarstår, kontakta oss på stjarnakademien@gmail.com så hjälper vi dig. Se också till att inte rensa webbläsarens cache, eftersom det tar bort dina framsteg.",
        faqQ9: "Kan jag skicka förslag och frågor?",
        faqA9: "Ja, maila gärna: stjarnakademien@gmail.com",
