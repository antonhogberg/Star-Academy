const translations = {
    en: {
        ...
        faqQ5: "Can I use Star Academy if I already know how to play the piano, and how advanced are the exercises?",
        faqA5: "Yes, even if you already know how to play the piano, you can use Star Academy! The exercises are divided into four parts with different levels: Part 1 is for beginners, Part 2 is for slightly more experienced students, Part 3 is for advanced students, and Part 4 features mostly very advanced exercises for experienced pianists. Start with exercises that match your level, or begin from the start to collect some easy stars. Earn stars to climb ranks and improve your skills, regardless of your level.",
        faqQ6: "How many ranks are there?",
        faqA6: "There are six ranks in Star Academy: Explorer, Star Cadet, Star Officer, Star Captain, Star Commander, and Star Admiral. You climb ranks by earning stars in exercises, and the highest rank, Star Admiral, is achieved by earning six stars in every exercise in every chapter.",
        faqQ7: "Do I need a piano to use Star Academy?",
        faqA7: "To use Star Academy, you need access to a piano or keyboard to practice the exercises in the Star Academy Piano School. A keyboard with at least 61 keys works well for beginners, but a piano is ideal for developing proper technique. You don’t need to own a piano—you can use one at a school or rent one if needed.",
