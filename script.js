const translations = {
    en: {
        ...
        faqA5: "The Rank Badge has a bottom field where the first 16 completed exercises light up small stars, tracking your progress from Explorer to Star Cadet. Once this field is full after 16 exercises, you achieve the Star Cadet rank, and the badge on the right updates from empty stars to all golden stars. The badge also features four chevrons, each with large stars that light up as you complete all four exercises in a Part. The first chevron’s stars correspond to Part 1 in all seven chapters, the second to Part 2, and so on up to Part 4. As you fill each chevron with stars, you progress through the ranks: Star Officer after Part 1, Star Captain after Part 2, Star Commander after Part 3, and Star Admiral after Part 4. The badge on the right gains a matching chevron for each part you complete.",
    ...
    sv: {
        ...
        faqA5: "Rangmärket har ett nedre fält där de första 16 slutförda övningarna tänder små stjärnor, vilket visar din väg från Utforskare till Stjärnkadett. När detta fält är fullt efter 16 övningar uppnår du Stjärnkadett-rangen, och märket till höger uppdateras från tomma stjärnor till gyllene stjärnor. Märket har också fyra chevroner, där varje chevron har stora stjärnor som tänds när du slutför alla fyra övningar i en Del. Den första chevronens stjärnor motsvarar Del 1 i alla sju kapitel, den andra Del 2, o.s.v. När du fyller en chevron med stjärnor klättrar du i rang: Stjärnofficer efter Del 1, Stjärnkapten efter Del 2, Stjärnkommendör efter Del 3 och Stjärnamiral efter Del 4. Märket till höger får en motsvarande chevron för varje Del du slutför.",
