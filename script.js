const translations = {
    en: {
        ...
        popupTeacherNote: "You can also focus on a specific chapter if Scales or Chords is what you want to excel at. Visit the chapter pages to start earning stars, check your progress on the Star Overview page, or manage students on the For Teachers page. Ready to uncover musical treasures?",
    ...
    sv: {
        ...
        popupTeacherNote: "Du kan också fokusera på ett specifikt kapitel om du vill bli extra bra på t.ex. skalor eller ackord. Besök kapitel-sidorna för att börja samla stjärnor, se dina framsteg på Stjärnöversikt-sidan, eller hantera elever på sidan För lärare. Är du redo att hitta musikaliska skatter?",
