const translations = {
    en: {
        ...
        popupIntro: "Click to reveal your North Star Piano School stars! Earn six stars in exercises to rise in rank—track your progress under Star Overview.",
        ...
        faqQ3: "How does the ranking system work in North Star Piano School?",
        faqA3: "In North Star Piano School, you climb ranks by earning stars in exercises. You start as an Explorer and need to earn six stars in 16 exercises to become a Star Cadet. To reach the next rank, Star Officer, you must complete Part 1 in all seven chapters. Each rank requires completing more parts in the chapters, up to Star Admiral, where you have six stars in every exercise in every chapter.",
        faqQ4: "How much time should I spend practicing each day?",
        faqA4: "We recommend practicing 15–30 minutes per day in addition to the time you spend on pieces, depending on your level and age. Beginners can start with 15 minutes, while more advanced students can aim for 30 minutes. Try to practice daily to make steady progress, and focus on your active exercises to earn stars.",
        faqQ5: "Can I use North Star Piano School if I already know how to play the piano, and how advanced are the exercises?",
        faqA5: "Yes, even if you already know how to play the piano, you can use North Star Piano School! The exercises are divided into four parts with different levels: Part 1 is for beginners, Part 2 is for slightly more experienced students, Part 3 is for advanced students, and Part 4 features mostly very advanced exercises for experienced pianists. Start with exercises that match your level, or begin from the start to collect some easy stars. Earn stars to climb ranks and improve your skills, regardless of your level.",
        faqQ6: "How many ranks are there?",
        faqA6: "There are six ranks in North Star Piano School: Explorer, Star Cadet, Star Officer, Star Captain, Star Commander, and Star Admiral. You climb ranks by earning stars in exercises, and the highest rank, Star Admiral, is achieved by earning six stars in every exercise in every chapter.",
        faqQ7: "Do I need a piano to use North Star Piano School?",
        faqA7: "To use North Star Piano School, you need access to a piano or keyboard to practice the exercises in the North Star Piano School. A keyboard with at least 61 keys works well for beginners, but a piano is ideal for developing proper technique. You don’t need to own a piano—you can use one at a school or rent one if needed.",
        faqQ8: "What should I do if I have technical issues with the website?",
        faqA8: "If you have technical issues with the website, try refreshing the page or checking your internet connection. If the problem persists, contact us at northstarpianoschool@gmail.com, and we’ll assist you. Also, make sure not to clear your browser’s cache, as it will remove your progress.",
        faqQ9: "Can I send suggestions or questions?",
        faqA9: "Yes, feel free to email: northstarpianoschool@gmail.com",
        faqQ10: "Why did my progress disappear?",
        faqA10: "If you cleared your browser history, all star data was removed as it’s stored in the browser’s cache. If you imported a user with your name from another device via a link or QR code created on the For Teachers page, your user data was overwritten by the imported user.",
        faqQ11: "Can I share a student’s progress with them, if they want to see the stars on their own iPad?",
        faqA11: "Yes, you can share a student’s progress! On the For Teachers page, select the student and generate a share link or QR code. The student can scan the QR code using their iPad’s camera app to import their progress, or you can send the import link via SMS, email, or AirDrop for them to open on their device. This allows them to view their stars and progress on their own iPad.",
    ...
    sv: {
        ...
        popupIntro: "Klicka fram dina Nordstjärnans Pianoskola-stjärnor här! Samla sex stjärnor i övningarna för att klättra i rang – kolla dina framsteg under Stjärnöversikt.",
        ...
        textboxStarAdmiral: "Dina ansträngningar och ditt fokus har gjort dig till en pianovirtuos. Du är Stjärnamiral i Nordstjärnans Pianoskola, härskare över alla kapitel.",
        chapter1: "Kapitel 1",
        chapter2: "Kapitel 2",
        chapter3: "Kapitel 3",
        chapter4: "Kapitel 4",
        ...
        faqQ1: "Hur använder jag Stjärnkartan för att tjäna stjärnor?",
        ...
        faqQ3: "Hur fungerar rangsystemet i Nordstjärnans Pianoskola?",
        faqA3: "I Nordstjärnans Pianoskola klättrar du i rang genom att tjäna stjärnor i övningar. Du börjar som Utforskare och behöver samla sex stjärnor i 16 övningar för att bli Stjärnkadett. För att nå nästa rang, Stjärnofficer, måste du klara del 1 i alla sju kapitel. Varje rang kräver att du slutför fler delar i kapitlen, upp till Stjärnamiral, där du har sex stjärnor i alla övningar i alla kapitel.",
        faqQ4: "Hur mycket tid bör jag lägga på att öva varje dag?",
        faqA4: "Vi rekommenderar att du övar 15–30 minuter per dag utöver den tid du lägger på stycken, beroende på din nivå och ålder. Nybörjare kan börja med 15 minuter, medan mer avancerade elever kan sikta på 30 minuter. Försök att öva varje dag för att göra stadiga framsteg, och fokusera på dina aktiva övningar för att tjäna stjärnor.",
        faqQ5: "Kan jag använda Nordstjärnans Pianoskola om jag redan kan spela piano, och hur avancerade är övningarna?",
        faqA5: "Ja, om du redan kan spela piano kan du ändå använda Nordstjärnans Pianoskola! Övningarna är uppdelade i fyra delar med olika nivåer: Del 1 är för nybörjare, Del 2 är för något mer erfarna elever, Del 3 är för avancerade elever, och Del 4 är överlag väldigt avancerade övningar för erfarna pianister. Börja med övningar som matchar din nivå eller starta från början för att samla några lätta stjärnor. Tjäna stjärnor för att klättra i rang och förbättra dina färdigheter, oavsett din nivå!",
        faqQ6: "Hur många ranger finns det?",
        faqA6: "Det finns sex ranger i Nordstjärnans Pianoskola: Utforskare, Stjärnkadett, Stjärnofficer, Stjärnkapten, Stjärnkommendör och Stjärnamiral. Du klättrar i rang genom att tjäna stjärnor i övningar, och den högsta rangen, Stjärnamiral, uppnår du genom att få sex stjärnor på alla övningar i alla kapitel.",
        faqQ7: "Behöver jag ett piano för att använda Nordstjärnans Pianoskola?",
        faqA7: "För att använda Nordstjärnans Pianoskola behöver du tillgång till ett piano eller ett keyboard för att öva på övningarna i Nordstjärnans Pianoskola. Ett keyboard med minst 61 tangenter fungerar bra för nybörjare, men ett piano är idealiskt för att utveckla rätt teknik. Du behöver inte äga ett piano—du kan använda ett på en skola eller hyra ett om det behövs.",
        faqQ8: "Vad gör jag om jag har tekniska problem med hemsidan?",
        faqA8: "Om du har tekniska problem med hemsidan, prova att ladda om sidan eller kontrollera din internetanslutning. Om problemet kvarstår, kontakta oss på nordstjarnanspianoskola@gmail.com så hjälper vi dig. Se också till att inte rensa webbläsarens cache, eftersom det tar bort dina framsteg.",
        faqQ9: "Kan jag skicka förslag och frågor?",
        faqA9: "Ja, maila gärna: nordstjarnanspianoskola@gmail.com",
        faqQ10: "Varför försvann mina framsteg?",
        faqA10: "Om du har rensat din historik i din webbläsare så försvann all data som visar stjärnor eftersom denna lagras i webbläsarens cacheminne. Om du har importerat en användare med ditt namn från en annan enhet via en länk eller QR-kod som skapats på För lärare-sidan så har din användare skrivits över av den importerade användaren.",
        faqQ11: "Kan jag dela en elevs framsteg med dem, om de vill se sina stjärnor på sin egen iPad?",
        faqA11: "Ja, du kan dela en elevs framsteg! På För lärare-sidan, välj eleven och generera en delningslänk eller QR-kod. Eleven kan skanna QR-koden med sin iPads kameraapp för att importera sina framsteg, eller så kan du skicka importlänken via SMS, e-post eller AirDrop för att de ska kunna öppna den på sin enhet. Detta gör det möjligt för dem att se sina stjärnor och framsteg på sin egen iPad.",
